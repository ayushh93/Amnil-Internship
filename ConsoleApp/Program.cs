...
ADOintro.CheckConnection();
Console.WriteLine("The datas in the table are as follows:");
ADOintro.GetData();
//ADOintro.InsertData();
//ADOintro.UpdateData();  
//ADOintro.DeleteData();
ADOintro.InsertUserData();
Console.WriteLine("The updated datas in the table are as follows:");
ADOintro.GetData();
